...
public class AppointmentBlockResource1_9ControllerTest extends MainResourceControllerTest {
	...
	public void shouldCreateNewAppointmentBlock() throws Exception {
		...
		int originalCount = 5;
		// a brand new appointment block can no longer be dated in the past, so this uses a far-future date
		// rather than the historical 2005 date this test originally used
